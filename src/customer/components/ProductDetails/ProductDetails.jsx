    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
                ...
                <p className="text-sm font-medium text-indigo-600 hover:text-indigo-500">3870 Reviews</p>
                </div>
        ...
        <section>
          ...
          <div className="border p-5">
            <Grid container spacing={7}>
                ...
                <Grid item xs={5}>
                    <h1 cassName="text-xl font-semibold pb-2">Product Ratings</h1>
                    <div className="flex items-center space-x-3">
                ...
                <Box className="mt-5 space-y-3">
                    ...
                    <Grid container  alignItems="center" >
                        ...
                        <Grid item xs={7}>
                            <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4,height:7}}variant="determinate" value={40} className='yellow'/>
        ...
        <section className="pt-10">
                    <h1 className="py-5text-xl font-bold "> Similiar Products</h1>
